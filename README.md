# 水动力引擎
A Dola AI Seedream engine. Generate high-quality images from text prompts using BytePlus Seedream models. This project provides a robust Command Line Interface (CLI) and Python API to interact with Seedream 4.0, 4.5, and 5.0-lite models.

# Overview

水动力引擎 simplifies the process of creating AI-generated artwork. Whether you need quick visualizations, high-detailed art, or batch generation, this tool wraps the complex API interactions into simple commands.
...
Open Git Bash in your computer then type this command:
```bash
git clone https://github.com/John123-VN/shui-dongli-yinqing.git
cd shui-dongli-yinqing
```

### 2. Install Dependencies
Ensure you have Python 3.8+ installed. If you're on a latest Python version, [click here.](https://www.python.org/downloads/release/python-380)
...
Replace your-api-key-here to your BytePluses API key.
...
```bash
python3 scripts/seedream_image_generate.py -p "A beautiful girl"
```
